...
class N05Z03P03 {
	...
	public static void snimiStek(String f, Stek<Integer> stek) {
	...
	public static void metodZadatka1(Stek<Integer> stek) {
		
		if (!stek.jePrazan()) {
			
			int e = stek.vrh();
			
			while (!stek.jePrazan() && e % 10 == 6) {
	...
	public static void metodZadatka2(Stek<Integer> stek) {
	...
	public static Stek<Integer> metodZadatka3(Stek<Integer> s1, Stek<Integer> s2) {
	...
	public static void main(String[] args) {
		...
		Stek<Integer> s3 = metodZadatka3(s1, s2);
