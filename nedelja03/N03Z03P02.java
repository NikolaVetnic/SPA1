...
class N03Z03P02 {
	...
	public static void main(String[] args) {
		...
		lista.dodajNaPocetak("Kafa");
		lista.dodajNaPocetak("Lokvanj");
...
class Lista {
	...
	public int prebrojElemente() {
		...
		System.out.println("Broj elemenata koji pocinju velikim slovom: " + count);
		return count;
	}
	...
	public double prosecnaDuzina() {
		...
		System.out.println("Prosecna duzina stringova: " + sum / count);
		return sum / count;
	}
