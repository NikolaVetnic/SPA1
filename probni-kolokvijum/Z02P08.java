...
class Z02P08 {
	...
	public static void main(String[] args) {
		...
		lanac.dodajHotel("Sheraton", "Novi Sad");
			lanac.dodajRadnika("Redzep", 4.50, 15, "Sheraton");
			lanac.dodajRadnika("Riza", 3.50, 5, "Sheraton");
		lanac.dodajHotel("Sloboda", "Xabac");
			lanac.dodajRadnika("Markan", 100.50, 5, "Sloboda");
			lanac.dodajRadnika("Smrdivoje", 12.25, 15, "Sloboda");
		lanac.dodajHotel("Centar", "Novi Sad");
			lanac.dodajRadnika("Ljubisa", 2.50, 25, "Centar");
