...
class Z02P04 {
	...
	public static void main(String[] args) {
		...
		lanac.dodajHotel("Sloboda", "Xabac");
			lanac.dodajRadnika("Miki", 4.50, 25, "Sloboda");
			lanac.dodajRadnika("Zoki", 5.50, 15, "Sloboda");
			lanac.dodajRadnika("Kiki", 2.50, 5, "Sloboda");
		lanac.dodajHotel("Sheraton", "Novi Sad");
			lanac.dodajRadnika("Miljan", 4.50, 25, "Sheraton");
			lanac.dodajRadnika("Branislav", 6.50, 15, "Sheraton");
			lanac.dodajRadnika("Konjina", 2.50, 5, "Sheraton");
		lanac.dodajHotel("Hilton", "Beograd");
			lanac.dodajRadnika("Redzep", 4.50, 25, "Hilton");
			lanac.dodajRadnika("Shaki", 5.50, 15, "Hilton");
			lanac.dodajRadnika("Prpenj", 2.50, 5, "Hilton");
		lanac.dodajHotel("Centar", "Novi Sad");
			lanac.dodajRadnika("Gegan", 4.50, 25, "Centar");
...
class LanacHotela {
	...
	class Radnik {
		...
		public String toString() {
			return "[i]_" + ime + "-[p]_" + plata + "-[s]_" + staz;
		}
	}
