...
class LanacHotela {
	...
	public boolean obrisiHotel(String n) {
	...
	public void zatvoriHotel(String n) {
		...
		if (start == cilj || start.prviRadnik == null) {
		...
		while (start.prviRadnik != null && start.prviRadnik.s > 9) {
